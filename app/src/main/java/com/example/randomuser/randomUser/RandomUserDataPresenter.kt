...
class RandomUserDataPresenter(private val view:RandomUserDataContract.View):RandomUserDataContract.Presenter {

    override fun getRandomUserDetail(count: Int) {

      RandomUserDataClient().getUserDataService().getUserData(count).enqueue(object :Callback<RandomUserMain>{
          override fun onResponse(call: Call<RandomUserMain>, response: Response<RandomUserMain>) {
